...
# abjDash
  <!-- badges: start -->
  [![Codecov test coverage](https://codecov.io/gh/abjur/abjDash/branch/master/graph/badge.svg)](https://codecov.io/gh/abjur/abjDash?branch=master)
  <!-- badges: end -->
...
Para algumas funções de gráficos e relacionadas a construção de aplicativos Shiny a fase de teste está em *andamento*. 
Caso encontrar algum problema específico contribua em [issues](https://github.com/abjur/abjDash/issues).
